...
export default function ConfirmCodeScreen({ navigation, route }) {
   ...
   async function handleRegister(e) {
      ...
      console.log("senha2 " + senha2)
      if (senha.length < 8) {
         Alert.alert("Aviso", "Insira no mínimo 8 caracteres");
         return
      }
   ...
   return (
      <KeyboardAvoidingView style={styles.container}>
         ...
         />
         <View style={styles.yellowBox}>
            <Text style={styles.description}>Preencha os campos</Text>
            {/* <Text style={styles.description}>e cadastre sua senha</Text> */}
